...
#line 156 "src/lx/parser.act"
		...
		if (-1 == re_cflags(lex_state->buf.a + 1, &ZIf)) { /* TODO: +1 for '/' prefix */
			err(lex_state, "Unrecognised regexp flags: %s", lex_state->buf.a + 1);
