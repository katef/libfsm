...
z0(struct lx_sql_lx *lx)
{
	...
	case S18: return TOK_CLASS_UPPER;
	case S38: return TOK_CLASS_DIGIT;
	case S39: return TOK_CLASS_SPCHR;
	case S41: return TOK_CLASS_LOWER;
