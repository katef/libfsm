...
z3(struct lx_pcre_lx *lx)
{
	...
	while (c = lx_getc(lx), c != EOF) {
		...
		case S61: /* e.g. "\\x" */
			...
			case '7':
			case '8':
			case '9': state = S65; break;
			case 'A':
			case 'B':
			case 'C':
			case 'D':
			case 'E':
			case 'F': state = S65; break;
			case 'a':
			case 'b':
			case 'c':
			case 'd':
	...
	case S28: return TOK_NAMED__CHAR__CLASS;
