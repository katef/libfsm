...
int
utf8_Warang_Citi_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[2], s[3], 0xa2)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[2], s[4], 0xa3)) { return 0; }
	for (i = 0xa0; i <= 0xbf; i++) {
	...
	if (!fsm_addedge_literal(fsm, s[4], s[5], 0xbf)) { return 0; }
