...
int
utf8_Thai_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[1], s[2], 0xb8)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[1], s[3], 0xb9)) { return 0; }
	for (i = 0x81; i <= 0xba; i++) {
