...
utf8_C_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[6], s[27], 0xa3)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[7], s[18], 0xa0)) { return 0; }
	...
	if (!fsm_addedge_literal(fsm, s[10], s[16], 0xa3)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[10], s[16], 0xbb)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[10], s[17], 0xbf)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[11], s[20], 0x91)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[11], s[21], 0x9b)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[11], s[22], 0x9d)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[12], s[9], 0xb0)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[12], s[19], 0xbf)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[12], s[23], 0xa0)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[13], s[9], 0x80)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[13], s[19], 0x8f)) { return 0; }
	for (i = 0x8b; i <= 0x8f; i++) {
	...
	if (!fsm_addedge_literal(fsm, s[18], s[1], 0x8e)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[19], s[24], 0xbf)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[20], s[24], 0x82)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[21], s[25], 0xb2)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[22], s[26], 0x85)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[23], s[29], 0x80)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[23], s[30], 0x81)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[24], s[1], 0xbd)) { return 0; }
	for (i = 0xa0; i <= 0xa3; i++) {
