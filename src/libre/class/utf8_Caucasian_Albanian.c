...
int
utf8_Caucasian_Albanian_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[2], s[3], 0x94)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[2], s[4], 0x95)) { return 0; }
	for (i = 0xb0; i <= 0xbf; i++) {
	...
	if (!fsm_addedge_literal(fsm, s[4], s[5], 0xaf)) { return 0; }
