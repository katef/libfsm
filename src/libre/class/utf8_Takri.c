...
int
utf8_Takri_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[2], s[3], 0x9a)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[2], s[4], 0x9b)) { return 0; }
	for (i = 0x80; i <= 0xb7; i++) {
