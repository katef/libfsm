...
utf8_Sm_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[6], s[17], 0x81)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[18], 0x82)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[19], 0x84)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[20], 0x85)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[21], 0x86)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[22], 0x87)) { return 0; }
	for (i = 0x88; i <= 0x8b; i++) {
		if (!fsm_addedge_literal(fsm, s[6], s[23], i)) { return 0; }
	}
	for (i = 0xa4; i <= 0xa5; i++) {
		if (!fsm_addedge_literal(fsm, s[6], s[23], i)) { return 0; }
	}
	...
	if (!fsm_addedge_literal(fsm, s[6], s[24], 0x8c)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[25], 0x8d)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[26], 0x8e)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[27], 0x8f)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[28], 0x96)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[29], 0x97)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[30], 0x99)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[31], 0x9f)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[32], 0xa6)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[33], 0xa7)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[34], 0xac)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[6], s[35], 0xad)) { return 0; }
	...
	if (!fsm_addedge_literal(fsm, s[15], s[16], 0xbb)) { return 0; }
	for (i = 0xb0; i <= 0xb1; i++) {
		if (!fsm_addedge_literal(fsm, s[16], s[1], i)) { return 0; }
	}
	if (!fsm_addedge_literal(fsm, s[17], s[1], 0x84)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[17], s[1], 0x92)) { return 0; }
	for (i = 0xba; i <= 0xbc; i++) {
	...
	if (!fsm_addedge_literal(fsm, s[21], s[1], 0xa6)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[21], s[1], 0xae)) { return 0; }
	for (i = 0x8e; i <= 0x8f; i++) {
		if (!fsm_addedge_literal(fsm, s[22], s[1], i)) { return 0; }
	}
	if (!fsm_addedge_literal(fsm, s[22], s[1], 0x92)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[22], s[1], 0x94)) { return 0; }
	for (i = 0xb4; i <= 0xbf; i++) {
		if (!fsm_addedge_literal(fsm, s[22], s[1], i)) { return 0; }
	}
	for (i = 0x80; i <= 0xbf; i++) {
	...
	if (!fsm_addedge_literal(fsm, s[25], s[1], 0xbc)) { return 0; }
	for (i = 0x9b; i <= 0xb3; i++) {
