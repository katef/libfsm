...
int
utf8_Kaithi_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[2], s[3], 0x82)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[2], s[4], 0x83)) { return 0; }
	for (i = 0x80; i <= 0xbf; i++) {
