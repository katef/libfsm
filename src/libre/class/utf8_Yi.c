...
int
utf8_Yi_fsm(struct fsm *fsm, struct fsm_state *x, struct fsm_state *y)
{
	...
	if (!fsm_addedge_literal(fsm, s[1], s[3], 0x92)) { return 0; }
	if (!fsm_addedge_literal(fsm, s[1], s[4], 0x93)) { return 0; }
	for (i = 0x80; i <= 0xbf; i++) {
