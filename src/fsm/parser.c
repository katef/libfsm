...
#line 450 "src/fsm/parser.c"
		}
		/* END OF ACTION: add-state */
		/* BEGINNING OF ACTION: free */
		{
#line 247 "src/fsm/parser.act"

		free((ZIa));
	
#line 459 "src/fsm/parser.c"
		}
		/* END OF ACTION: free */
		/* BEGINNING OF ACTION: free */
		{
